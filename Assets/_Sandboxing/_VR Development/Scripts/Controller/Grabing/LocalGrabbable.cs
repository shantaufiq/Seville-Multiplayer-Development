...
public class LocalGrabbable : MonoBehaviour
{
    ...
    public LocalGrabInteractor currentGrabber;
    ...
    public UnityEvent<LocalGrabInteractor> onWillGrab = new UnityEvent<LocalGrabInteractor>();
    ...
    public virtual void Grab(LocalGrabInteractor newGrabber, Transform grabPointTransform = null)
    {
        ...
        if (networkGrabbable)
        {
            ...
            //? Debug.Log($"network component isn't null");
        }
        else
        {
            //? Debug.Log($"network component is null");
